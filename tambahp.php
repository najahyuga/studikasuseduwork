<html>
    ...
    <body>        
        <div class="container">		
            <form id="form-validation" method="POST" action="prosestambahp.php" enctype="multipart/form-data"><br>
            ...
            ?>
                ...
                <div class="input-group mb-3 input-group-lg">
                    ...
                    <input type="text" name="id_product" class="form-control" disabled>
                </div>
                ...
                <div class="input-group mb-3 input-group-lg">
                    ...
                    <input type="number" name="price_poduct" class="form-control">
                </div>
                ...
                <button type="submit" name ="submit" value="submit" button type ="button" class="btn btn-primary">SUBMIT</button>
